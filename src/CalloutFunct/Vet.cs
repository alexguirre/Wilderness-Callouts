...
namespace WildernessCallouts.Peds
{
    internal class Vet
    {
        ...
        public static List<Ped> TakenAnimals { get { return _takenAnimals; } }
        ...
        public Vet(Ped animalToTake)
        {
            ...
            VetPed.RelationshipGroup = new RelationshipGroup("VET");       // Sets the ped relation so he won't be scared or attacked
